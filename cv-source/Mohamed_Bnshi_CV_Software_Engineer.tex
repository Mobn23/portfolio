...
\begin{document}
    ...
    \begin{onecolentry}
        \textbf{Ericsson--BTH | Software Engineer (Intern) -- AI-driven Systems} \hfill \textit{Pågående}
        \begin{highlights}
    ...
    \begin{onecolentry}
        ...
        \begin{highlights}
            ...
            \item Arbetar med AI-driven analys för automatiserat beslutsfattande i CI/CD-processer
        \end{highlights}
    ...
    \begin{onecolentry}
        ...
        Akademiskt samarbete (sekretessbelagt)
        \begin{highlights}
            \item Kontraktsform: Akademiskt samarbete (sekretessbelagt)
